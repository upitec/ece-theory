...
# This is the spin connection vector of omega_0=-c/r*cos(theta)
      ...
      dx3(x,y)=enorm(x,y) > coef/.7 ? 0 : 10*dx2(x,y)
      dy3(x,y)=enorm(x,y) > coef/.7 ? 0 : 10*dy2(x,y)
#
      coef=.7
      x0=0.
      y0=1.
...
plot "++" u 1:2:(coef*dx1($1,$2)):(coef*dy1($1,$2)) w vec lw 2.5#, $equipo2 w l lw 1.5
pause -1
plot "++" u 1:2:(coef*dx2($1,$2)):(coef*dy2($1,$2)) w vec lw 2.5#, $equipo2 w l lw 1.5
pause -1

plot "++" u 1:2:(coef*dx3($1,$2)):(coef*dy3($1,$2)) w vec lw 2.5#, $equipo2 w l lw 1.5

set terminal png transparent nocrop enhanced size 1000,1000 font "arial,20" 
set output 'Fig7a.png'
set border lw 3
plot "++" u 1:2:(coef*dx3($1,$2)):(coef*dy3($1,$2)) w vec lw 3#, $equipo2 w l lw 3
pause -1
set output 'Fig7.png'
set border lw 3
plot "++" u 1:2:(coef*dx1($1,$2)):(coef*dy1($1,$2)) w vec lw 3#, $equipo2 w l lw 3
pause -1
