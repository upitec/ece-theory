...
#
# This is the electric vector potential of omega_0=-c/r*cos(theta)
      e1x(x,y)= -3*q1*x/r(x,y)**3
      e1y(x,y)= -q1*(2*y**2-x**2)/r(x,y)**3
      e2x(x,y)= 0
      e2y(x,y)= 0
      ...
      dx3(x,y)=enorm(x,y) > coef/1.6 ? 0 : 10*dx2(x,y)
      dy3(x,y)=enorm(x,y) > coef/1.6 ? 0 : 10*dy2(x,y)
#
      coef=.7
      x0=0.
      y0=1.
